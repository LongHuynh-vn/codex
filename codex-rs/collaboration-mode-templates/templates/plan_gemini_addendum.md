...
For multi-part work only:

* Add a short risk register focused on the design's own seams.
* Mark each risk as VALIDATED or REJECTED with the source fact that supports the verdict.
